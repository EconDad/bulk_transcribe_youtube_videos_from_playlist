...
def build_formula_extraction_repair_prompt(
    *,
    ...
    return (
        ...
        + "Identifiers must begin with a lowercase letter. A quantity that "
        + "begins with digits must be written as a numeric literal in the "
        + "ASCII expression or assigned a source-grounded semantic identifier "
        + "that begins with a letter; never emit a symbol such as "
        + "123_units. "
